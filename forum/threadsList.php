...
<body>
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        $sqlp = "INSERT INTO `threads` (`thread_title`, `thread_description`, `category_id`, `user_id`, `tstamp`) VALUES ('$title', '$desc', '$id', '$usid', current_timestamp());";
    ...
    <div class="container">
        <div class="my-4">
            <div class="card bg-dark text-white">
                <div class="card-body">
                    <h1 class="card-title">Welcome to <?php echo $catname;?> forums</h1>
                    <p class="card-text lead"><?php echo $catdesc;?></p>
                    <hr>
                    <p>Participate in online forums as you would in constructive, face-to-face discussions. Postings
                        should continue a conversation and provide avenues for additional continuous dialogue. Do not
                        post “I agree,” or similar, statements. Stay on the topic of the thread – do not stray.</p>
                    <a href="#" class="btn btn-success btn-kg" role="button">Learn more</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true){
            ...
            echo '<p class="lead">You are not logged in. Please login to start discussion.</p>';
        }
